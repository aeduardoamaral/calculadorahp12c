    ...
    <div className="flex items-center justify-center p-4 min-h-screen w-full bg-[#f8fafc]">
      <div className="calc-wrapper">
        <div className="brushed-metal w-[360px] sm:w-[540px] md:w-[840px] lg:w-[1020px] p-6 md:p-12 rounded-[40px] border-b-[10px] border-black/90">
          ...
          {/* Header e LCD */}
          <div className="flex justify-between items-start mb-10 md:mb-14 px-2">
            <div className="flex flex-col">
              <div className="flex items-center gap-6 md:gap-14">
                ...
                <div className="hidden sm:flex flex-col bg-black/40 px-4 py-1.5 rounded-md border border-white/5">
            ...
            <div className={`lcd-display w-[180px] sm:w-[280px] md:w-[480px] h-20 md:h-36 rounded-xl flex flex-col justify-center items-end px-6 md:px-14 transition-all duration-700 ${state.isOn ? 'bg-[#8da383]' : 'bg-[#151715] border-[#0a0a0a] shadow-none'}`}>
              {state.isOn && (
                <>
                  <div className="flex justify-between w-full text-[9px] md:text-[15px] font-black text-black/70 mb-1 md:mb-4">
                    <div className="flex gap-4 md:gap-12">
                      <span className={state.shift === 'f' ? 'text-black opacity-100 scale-125' : 'opacity-5'}>f</span>
                      <span className={state.shift === 'g' ? 'text-black opacity-100 scale-125' : 'opacity-5'}>g</span>
                    </div>
                    <span className="opacity-10 font-mono text-[8px] md:text-[12px] uppercase tracking-widest">Standard RPN</span>
                  </div>
                  <span className="text-3xl sm:text-5xl md:text-8xl font-bold font-mono tracking-tighter text-[#1a241a] leading-none select-none">
                    {state.display}
                  </span>
                </>
              )}
          ...
          {/* Grid de Teclas - 10 Colunas Fixo */}
          <div className="grid grid-cols-10 gap-x-2 sm:gap-x-3 md:gap-x-4 gap-y-4 sm:gap-y-6 md:gap-y-10">
            ...
            {/* Ocupado pelo Row Span do ENTER */}
